...
<template>
  <div class="max-w-lg">
    <div class="flex items-center gap-3 mb-6">
      <UButton :to="`/admin/reservations/${id}`" variant="ghost" icon="i-lucide-arrow-left" size="sm" />
      <h1 class="text-2xl font-bold">Reservierung bearbeiten</h1>
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      <div class="flex gap-3 pt-2">
        <UButton :to="`/admin/reservations/${id}`" color="neutral" variant="ghost">Abbrechen</UButton>
