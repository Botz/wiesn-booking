...
<template>
  <div class="max-w-lg mx-auto px-4 py-16 text-center">
    ...
    <div v-if="success">
      ...
      <h1 class="text-2xl font-bold mb-2">Buchung storniert</h1>
      ...
      <UButton to="/">Zurück zur Startseite</UButton>
    </div>

    <!-- Error -->
    <div v-else-if="error">
      <div class="text-5xl mb-4">❌</div>
      <h1 class="text-2xl font-bold mb-2">Fehler</h1>
    ...
    <div v-else>
      ...
      <h1 class="text-2xl font-bold mb-2">Buchung stornieren</h1>
      ...
      <div class="flex gap-3 justify-center">
        ...
        <UButton color="error" :loading="loading" @click="cancel">
          Jetzt stornieren
        </UButton>
      </div>
    </div>
